        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('stok', $barang['stok']); ?>" name="stok" id="stok" type="text" class="form-control" placeholder="Jumlah...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('harga_beli', $barang['harga_jual']); ?>" name="harga_beli" id="harga_beli" type="text" class="form-control" placeholder="Rupiah.">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('harga_jual', $barang['harga_jual']); ?>" name="harga_jual" id="harga_jual" type="text" class="form-control" placeholder="Rupiah.">
