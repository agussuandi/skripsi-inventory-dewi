...
<head>
    ...
    <title><?= $title; ?> |Inventory Panen Jaya</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">Inventory Panen Jaya</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('barangkosong'); ?>">
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Inventory Panen Jaya &bull; by <?= anchor('https://www.dewi anggraeni.id', 'dewi anggraeni.id'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Klik "Logout" dibawah ini jika anda yakin ingin Meninggalkan Halaman!.</div>
