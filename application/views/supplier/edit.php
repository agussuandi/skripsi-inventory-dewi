    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="perusahaan">Perusahaan</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-fw fa-user"></i></span>
                            </div>
                            <input value="<?= set_value('perusahaan', $supplier['perusahaan']); ?>" name="perusahaan" id="nama_perusahaan" type="text" class="form-control" placeholder="Perusahaan...">
                        </div>
